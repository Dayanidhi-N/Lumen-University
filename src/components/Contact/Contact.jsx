...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "a3fd1f43-4dbe-441e-9777-3c5040638e5e");
  ...
  return (
    <div className="contact">
      <div className="contact-col">
        ...
        <ul>
          <li>
            <img src={mail_icon} alt="" /> Contact@dayanidhi.dev
          </li>
          <li>
          ...
          <li>
            ...
            77 Gandhi Salai, Whitefield
            <br /> MA 02139, Bangalore
          </li>
        </ul>
      </div>
      <div className="contact-col">
